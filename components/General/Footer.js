...
export default function Footer() {
    return (
        <div className="py-24 px-6 grid gap-8 justify-items-center text-center lg:px-52 container mx-auto">
            ...
            <div className="pt-20 w-full flex lg:divide-x-2 pb-2">
                ...
                <div className="flex items-center justify-between lg:px-16 w-full lg:flex-grow ">
                    ...
                    <Link
                        href="https://medium.com/@nearbalkans"
                        target="_blank"
                    >
                        <svg
                            width="32"
            ...
            <div className="text-lg grid lg:flex lg:gap-4">
